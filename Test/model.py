...
def create_dqn_model(input_shape, action_space):
    ...
    model.add(Conv2D(16, (8, 8), strides=(4, 4), input_shape=input_shape))  # Because we use images, we need to first set up a convolutional network and then flatten it down. Input_shape is image
